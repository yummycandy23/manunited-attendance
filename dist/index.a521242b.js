...
(async function() {
    const data = await (0, _api.getAttendancesByYear)();
    new (0, _autoDefault.default)(document.getElementById("attendances"), {
        type: "bar",
        options: {
            animation: false,
            plugins: {
...
},{"chart.js/auto":"d8NN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./api":"8Zgej"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getAttendancesByYear", ()=>getAttendancesByYear);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const url = "https://football-web-pages1.p.rapidapi.com/attendances.json";
const cubeToken = "64946c5f2dmsh748e5c4b627803ap1886a4jsn0338531dadc3";
const cubeApi = new CubejsApi(cubeToken, {
    apiUrl
});
async function getAttendancesByYear() {
    try {
    ...
    const resultSet = await cubeApi.load(attendancesByYearQuery);
    /*
...
*/ async function getDimensions() {
        const dimensionsQuery = {
            dimensions: [
                "Attendances.homeTeam",
                "Attendances.awayTeam"
            ],
            measures: [
                "Attendances.count"
            ],
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dNGmx","7Jfkl"], "7Jfkl", "parcelRequire30ab")
